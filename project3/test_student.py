...
from src.fsm import in_alphabet, move_inclusive
...
def test_e_closure():
  ...
  # print("Hello world")
  nfa1 = Fsm(['a'], [0,1,2,3], 0, [3], [(0, 'epsilon', 1), (1, 'epsilon', 2), (0, 'a', 3)])
  nfa2 = Fsm(['epsilon'], [0,1,2], 0, [0], [(0, 'epsilon', 1), (1, 'epsilon', 2), (2, 'epsilon', 0)])
  assert(move('a', [0], nfa1) == [3])
  assert(move('epsilon', [1], nfa1) == [2])
  # print(move_inclusive('epsilon', [0], nfa1))
  # assert(move('epsilon', [2], nfa1) == [2])
  assert(e_closure([0], nfa1) == [0,1,2])
  assert(e_closure([0], nfa2) == [0,1,2])
  assert(move('a', [0], nfa1) == [3])
  # print(move('epsilon', [0,1], nfa1))
  # print(move('epsilon', [2], nfa1))
  # print(move('epsilon', [0,1,2], nfa1))
  # print(get_direct_edges('epsilon', [0], nfa1))
  make_visual(nfa1)
  # print(e_closure([0], nfa1))
  # assert(1 == 0)
